/*
Hardware monitoring dashboard to show events flowing through Interception
*/
#SingleInstance force
Persistent
#include lib\AutoHotInterception.ahk
#include lib\monitor_lib.ahk
...
loop 2 {
    ...
    loop 10 {
        ...
        textHandle := monitorGui.Add("Text", "x" columnX[devType] + idW " y" rowY + vhOff, "Handle:`t`t" StrReplace(
            strings[A_index].Handle, "&", "&&"))
...
chkFilterMove := monitorGui.Add("CheckBox", "x" columnX["M"] " w" totalWidths[devType] " yp Checked",
    "Filter Movement (Warning: Turning off can cause crashes)")
...
; Output
lvKeyboard := monitorGui.Add("ListView", "x" columnX["K"] " y" lowest " w" totalWidths["K"] " h" outputH, ["ID",
    "Code", "State", "Key Name"])
lvKeyboard.ModifyCol(4, 100)

lvMouse := monitorGui.Add("ListView", "x" columnX["M"] " yp w" totalWidths["M"] " h" outputH, ["ID", "Code",
    "State", "X", "Y", "Info"])
